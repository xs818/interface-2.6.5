describe('Remove Liquidity', () => {
  it('redirects', () => {
    cy.visit('/remove/0x84AAE7156fF15D2ce0cFDd3A4714E9524890C714-0xF9bA5210F91D0474bd1e1DcDAeC4C58E359AaD85')
    cy.url().should(
      'contain',
      '/remove/0x84AAE7156fF15D2ce0cFDd3A4714E9524890C714/0xF9bA5210F91D0474bd1e1DcDAeC4C58E359AaD85'
    )
  })
  ...
  it('does not crash if ETH is duplicated', () => {
    cy.visit('/remove/0x84AAE7156fF15D2ce0cFDd3A4714E9524890C714-0x84AAE7156fF15D2ce0cFDd3A4714E9524890C714')
    cy.get('#remove-liquidity-tokena-symbol').should('contain.text', 'WETH')
